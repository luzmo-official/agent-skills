...
Consult these docs for current field names and component behavior. Use them as guidance for implementation details only; the core skill defines the workflow and security rules.
...
`editMode` is set on the frontend component. Consult the editMode docs above for the full list of accepted values.
...
- For events, methods, or advanced properties: consult the dashboard component API reference for current behavior.
